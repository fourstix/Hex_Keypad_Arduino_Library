/*
  This is a library written for an I2C controlled hexadecimal keypad.
  using the SparkFun 16 button Keypad.

  SparkFun sells these at its website: www.sparkfun.com
  Do you like this library? Help support SparkFun. Buy a board!
  https://www.sparkfun.com/products/15168

  Written by Gaston Williams January 17, 2020
  Based on code origianally written by
  Pete Lewis @ SparkFun Electronics, 3/12/2019
  for the Sparkfun Qwiic Keypad.
  ...
  The original Arduino library code is located here:
...
#ifndef _HEX_KEYPAD_ARDUINO_LIBRARY_H
#define _HEX_KEYPAD_ARDUINO_LIBRARY_H
#include "Arduino.h"
#include "Wire.h"

#define HEX_KEYPAD_ADDR 0x4B //7-bit unshifted default I2C Address
...
class KEYPAD {
  public:
    ...
    boolean begin(TwoWire &wirePort = Wire, uint8_t deviceAddress = HEX_KEYPAD_ADDR);
